...
public interface IGoGameService extends Remote {
    ...
    // Host -> Receiver: host quyết định start/cancel sau khi receiver accept
    // (handshake bước 2)
    ...
    /**
     * Gửi kết quả tính điểm từ host đến rival.
     * Chỉ host (peer tạo phòng) gọi AI tính điểm, sau đó gửi kết quả cho đối thủ.
     * 
     * @param gameId      ID của game
     * @param scoreResult kết quả tính điểm (ví dụ: "B+2.5" hoặc "Đen thắng 5.5
     *                    điểm")
     */
    void sendScoreResult(String gameId, String scoreResult) throws RemoteException;
}